...
public static class UpgradeTempData
{
    public static List<UpgradeData> GetAll()
    {
        ...
        table.Add(new UpgradeData { ID = 200010100, GroupID = "501", applyType = (ApplyType)1, StatType = (StatType)1, Level = 0, Cost = 1, Value = 10f, Probability = 1f, IsMax = false });
        table.Add(new UpgradeData { ID = 200010200, GroupID = "501", applyType = (ApplyType)1, StatType = (StatType)2, Level = 0, Cost = 2, Value = 10f, Probability = 1f, IsMax = false });
        ...
        table.Add(new UpgradeData { ID = 200010400, GroupID = "501", applyType = (ApplyType)2, StatType = (StatType)4, Level = 0, Cost = 4, Value = 1.01f, Probability = 1f, IsMax = false });
