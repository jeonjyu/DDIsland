...
public class StoreData : MonoBehaviour
{
    ...
    [field: SerializeField] public IslandStoreDatabaseSO IslandStoreData { get; private set; }
    [field: SerializeField] public LakeStoreDatabaseSO LakeStoreData { get; private set; }
